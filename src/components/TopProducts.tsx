...
export function TopProducts({
  ...
  return (
    <div id="products" className="px-[5%] mt-16 scroll-mt-[100px] w-full">
      ...
      <motion.div
        ...
        className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[20px]"
      >
        {displayedProducts.map((product: any) => (
          ...
          >
            ...
            <div className="md:p-4 p-2 flex flex-col flex-grow">
              ...
              <h3 className="font-bold text-[14px] md:text-[16px] text-m-ink leading-[1.3] mb-2 transition-colors line-clamp-2">
                {product.name}
              </h3>
